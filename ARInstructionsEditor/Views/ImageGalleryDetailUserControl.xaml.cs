...
{
    public sealed partial class ImageGalleryDetailUserControl : UserControl, INotifyPropertyChanged
    {
        ...
        public ImageGalleryDetailUserControl()
        {
            InitializeComponent();
        }
        ...
        //    var data = await InstructionDataProvider.GetImagesByStepNumber(0); /*SampleDataService.GetImageGalleryDataAsync("ms-appx:///Assets");*/
